(function() {
    ...
    $.extend({
        sinaface: function(opt) {
            ...
            //触发按钮
            $(document).on('click', '.sina-face-handle', function(e) {
                handle = $(this);
            ...
            //Tab切换
            $(document).on('click', '.sina-face-head a', function(e) {
            ...
            //点击图标插入
            $(document).on('click', '.sina-face-body a', function(e) {
            ...
            //阻止关才
            $(document).on('click', '.sina-face', function(e) {
                e.stopPropagation();
            });
